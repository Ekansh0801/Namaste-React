Fun Fact -> npm is everything but not node package manager. It is used to manage Javascript packages but its not node package manager officialy its website doen not contain this name anywhere
